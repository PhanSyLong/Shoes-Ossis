...
import vn.sourcecode.service.UserDetailsServiceImpl;
...
public class SecureConfigurer extends WebSecurityConfigurerAdapter {
	...
	protected void configure(final HttpSecurity http) throws Exception {
		...
		.antMatchers("/frontend/**", "/backend/**", "/FolderUpload/**", "/login", "/logout").permitAll()
...
//		System.out.println(new BCryptPasswordEncoder(4).encode("2004"));
//	}
}
